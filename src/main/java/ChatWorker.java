...
public class ChatWorker implements Runnable {
            ...
            while (running) {
                ...
                if (request != null) {
                    ...
                    if (request.startsWith("/name")) {
                        String name = request.split(" ").length > 1 ? request.split(" ")[1] : "Guest-" + workers.size();
                        this.name = name;
                    } 
                        ...
                        if(name != null){
                            ...
                            addMessage("Help: /whisper [name] [message]");
                        }
                        ...
                        if(this.whisperer != null){
                            ...
                            addMessage("Error: The user you are trying to contact not available");
                        }
                    }
                    else {    
                        switch (request) {
    ...
    public void whisper(String message, String receiver){
        ...
        if(worker != null){
            ...
            worker.addMessage(String.format("/whisperFrom %s: %s", this.name, message));
        }else {
